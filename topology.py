...
class Connection(AbstractConnection):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.type_of_connection == 1:    
            self.w = torch.diagflat(torch.diagonal(self.w, 0))
        if self.type_of_connection == 2:    
            self.w = (self.w-torch.diagflat(torch.diagonal(self.w, 0)))
